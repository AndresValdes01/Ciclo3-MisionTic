...
const ProductPage = () => {
    ...
    useEffect( () => {
        ...
        const getDataAPI = async () => {
            const response = await fetch( `http://vitafamilyfrontend.herokuapp.com/api/productos`, {
                method: 'GET',
                headers: {
    ...
    const deleteProduct = async ( productId ) => {
        const response = await fetch( `http://vitafamilyfrontend.herokuapp.com/api/productos/${ productId }`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json;charset=utf-8'
            }
    ...
    const updateProduct = async () => {
        ...
        const response = await fetch( `http://vitafamilyfrontend.herokuapp.com/api/productos/${ formData._id }`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json;charset=utf-8'
            },
